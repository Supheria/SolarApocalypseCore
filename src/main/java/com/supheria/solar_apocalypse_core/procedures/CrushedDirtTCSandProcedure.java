...
public class CrushedDirtTCSandProcedure {
    public static void execute(LevelAccessor world, double x, double y, double z) {
        ...
        // 阶段 1-5：白天、天空可见、不下雨、dayTime≥48000 时，概率性转为沙子
        if (stage >= 1 && stage < 6
                && !isNight
        ...
        // 阶段 5：高于阶段5安全高度，进一步向碎泥土17邻扩散（含下层）
